import { a as img, c as pileMatrix, d as soilMachinery, f as stats, l as pileTypes, o as installSteps, p as whyBigscrew, t as applications, u as services } from "./data-DICVWIok.js";
import { c as ArrowLink } from "./router-Ddo4EKlf.js";
import { n as Reveal, r as TechLine, t as Label } from "./motion-primitives-WdXfCk5u.js";
...
function Hero() {
	return /* @__PURE__ */ jsxs("section", {
		...
		children: [
			...
			/* @__PURE__ */ jsx("div", { className: "absolute inset-0 bg-gradient-to-t from-ink via-ink/70 to-ink/40" }),
			/* @__PURE__ */ jsxs("div", {
				...
				children: [
					...
					/* @__PURE__ */ jsxs("h1", {
						...
						children: [["Foundations,", "driven not"].map((line, i) => /* @__PURE__ */ jsx("span", {
			...
			/* @__PURE__ */ jsx(motion.div, {
				...
				children: /* @__PURE__ */ jsxs("div", {
					...
					children: [
						...
						installSteps.map((s) => /* @__PURE__ */ jsxs("span", {
							className: "tech-label whitespace-nowrap text-on-ink-dim",
							children: [
								/* @__PURE__ */ jsx("span", {
...
//#endregion
//#region src/components/home/sections.tsx
var ease = [
	.16,
	.84,
	.24,
...
function TorqueBadge({ label }) {
	return /* @__PURE__ */ jsxs("span", {
		...
		children: [/* @__PURE__ */ jsx("span", { className: "h-1.5 w-1.5 bg-ink/70" }), label]
	});
}
				...
				/* @__PURE__ */ jsx("div", {
					...
					children: services.map((s, i) => /* @__PURE__ */ jsx(Reveal, {
						...
						children: /* @__PURE__ */ jsxs("div", {
							...
							children: [
								/* @__PURE__ */ jsx(TechLine, { className: "transition-transform duration-300 group-hover:scale-x-105" }),
								/* @__PURE__ */ jsx("p", {
			...
			children: [/* @__PURE__ */ jsx(motion.div, {
				...
				children: /* @__PURE__ */ jsxs("div", {
					...
					children: [
						...
						/* @__PURE__ */ jsx("div", { className: "pointer-events-none absolute inset-x-0 bottom-0 h-1/3 bg-gradient-to-t from-black/30 via-black/0 to-transparent" }),
						/* @__PURE__ */ jsx("span", {
							"aria-hidden": true,
						...
						/* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsx("span", { className: "h-1.5 w-1.5 rounded-full bg-yellow" }), /* @__PURE__ */ jsx("span", {
				...
				/* @__PURE__ */ jsxs("h2", {
					...
					children: ["Steel, thread, ", /* @__PURE__ */ jsx("span", {
						className: "text-yellow",
						children: "and ground"
					})]
				}),
	...
	return /* @__PURE__ */ jsx("section", {
		...
		children: /* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsx(Label, {
				...
				children: whyBigscrew.map((w, i) => /* @__PURE__ */ jsxs(Reveal, {
					delay: i * .07,
		...
		children: /* @__PURE__ */ jsxs("div", {
			...
			children: [
				...
				/* @__PURE__ */ jsx("ol", {
					...
					children: installSteps.map((s, i) => /* @__PURE__ */ jsxs(Reveal, {
						as: "li",
						delay: i * .08,
		...
		children: /* @__PURE__ */ jsxs("div", {
			...
			children: [
				...
				/* @__PURE__ */ jsx("div", {
					...
					children: pileTypes.map((p, i) => /* @__PURE__ */ jsxs(Reveal, {
						delay: i * .1,
						...
						children: [
							/* @__PURE__ */ jsxs("div", {
								...
								children: [/* @__PURE__ */ jsx(motion.span, {
									...
									}), /* @__PURE__ */ jsx("div", { className: "pointer-events-none absolute inset-0 bg-gradient-to-t from-black/10 via-transparent to-transparent opacity-0 transition-opacity duration-500 group-hover:opacity-100" })]
								})]
							}),
							/* @__PURE__ */ jsx("h3", {
							...
							/* @__PURE__ */ jsx("span", { className: "mt-3 h-[2px] w-8 origin-center bg-yellow/60 transition-all duration-500 ease-out group-hover:w-16 group-hover:bg-yellow" }),
							/* @__PURE__ */ jsx("p", {
					...
					children: /* @__PURE__ */ jsxs("table", {
						...
						children: [
							...
							/* @__PURE__ */ jsx("thead", { children: /* @__PURE__ */ jsxs("tr", { children: [/* @__PURE__ */ jsx("th", {
								...
								children: "Pile type"
							}), pileMatrix.columns.map((c) => /* @__PURE__ */ jsx("th", {
								scope: "col",
								className: "border-b border-on-ink/20 py-4 pr-6 text-center tech-label text-on-ink-dim",
								children: c
							}, c))] }) }),
							/* @__PURE__ */ jsx("tbody", { children: pileMatrix.rows.map((r) => /* @__PURE__ */ jsxs("tr", {
			...
			children: [
				...
				/* @__PURE__ */ jsx("div", {
					...
					children: applications.map((a, i) => {
						if (i === lastIndex) return /* @__PURE__ */ jsx(Reveal, {
							delay: i % 3 * .07,
							className: "group bg-background md:col-span-2 lg:col-span-3",
							children: /* @__PURE__ */ jsxs(ArrowLink, {
								...
								children: [/* @__PURE__ */ jsx("div", {
									...
									children: [
										...
										/* @__PURE__ */ jsxs("span", {
											...
											children: ["View application ", /* @__PURE__ */ jsx("span", {
												"aria-hidden": true,
												children: "→"
											})]
										})
		...
		children: /* @__PURE__ */ jsxs("div", {
			...
			children: [
				...
				/* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsx("div", {
						...
						children: [
							...
							"Drive head",
							"Pile approach"
						].map((h) => /* @__PURE__ */ jsx("span", {
							className: "pt-5 tech-label text-muted-foreground",
							children: h
						}, h))
					}), soilMachinery.map((r, i) => /* @__PURE__ */ jsxs(Reveal, {
						as: "div",
						delay: i * .05,
						...
						children: [
							...
							/* @__PURE__ */ jsx(TorqueBadge, { label: r.driveHead }),
							/* @__PURE__ */ jsx("span", {
				...
				/* @__PURE__ */ jsx("div", {
					...
					children: soilMachinery.map((r, i) => /* @__PURE__ */ jsxs(Reveal, {
						delay: i * .05,
						...
						children: [/* @__PURE__ */ jsxs("div", {
							...
							children: [["Carrier machine", r.carrier], ["Pile approach", r.approach]].map(([k, v]) => /* @__PURE__ */ jsxs("div", {
...
function ClosingCta() {
	...
	return /* @__PURE__ */ jsxs("section", {
		...
		children: [
			...
			/* @__PURE__ */ jsx("div", { className: "absolute inset-0 bg-gradient-to-b from-ink/55 via-ink/40 to-ink/60" }),
			/* @__PURE__ */ jsxs("div", {
...
function Index() {
	return /* @__PURE__ */ jsxs(Fragment, { children: [
		...
		/* @__PURE__ */ jsx(WhyBigscrew, {}),
		/* @__PURE__ */ jsx(ProductCloseUp, {}),
		/* @__PURE__ */ jsx(Stats, {}),
		/* @__PURE__ */ jsx(Process, {}),
		/* @__PURE__ */ jsx(PileTypes, {}),
		/* @__PURE__ */ jsx(Machinery, {}),
		/* @__PURE__ */ jsx(ApplicationsGrid, {}),
