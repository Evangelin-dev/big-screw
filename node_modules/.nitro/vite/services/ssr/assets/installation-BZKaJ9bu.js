import { a as img, d as soilMachinery } from "./data-DICVWIok.js";
import { n as Reveal, t as Label } from "./motion-primitives-WdXfCk5u.js";
import { t as PageHero } from "./PageHero-CwH4hGRu.js";
import { useEffect, useRef, useState } from "react";
import { Fragment, jsx, jsxs } from "react/jsx-runtime";
import { AnimatePresence, motion, useScroll, useTransform } from "framer-motion";
//#region src/routes/installation.tsx?tsr-split=component
var processSteps = [
	{
		n: "01",
					...
					/* @__PURE__ */ jsx("div", {
						...
						children: /* @__PURE__ */ jsxs("table", {
							...
							children: [/* @__PURE__ */ jsx("thead", { children: /* @__PURE__ */ jsx("tr", { children: [
								...
								"Drive head",
								"Pile approach"
							].map((h, index) => /* @__PURE__ */ jsx("th", {
								scope: "col",
								className: ["border-b border-border py-4 pr-6 tech-label text-muted-foreground", index === 0 ? "pl-6" : ""].join(" "),
								children: h
							}, h)) }) }), /* @__PURE__ */ jsx("tbody", { children: soilMachinery.map((r) => /* @__PURE__ */ jsxs("tr", {
								className: "align-top",
								children: [
									/* @__PURE__ */ jsx("th", {
										scope: "row",
				...
				children: [/* @__PURE__ */ jsxs("div", {
					...
					children: [
						...
						/* @__PURE__ */ jsxs("h2", {
							...
							children: ["Built in ", /* @__PURE__ */ jsx("span", {
						...
						/* @__PURE__ */ jsxs("div", {
							...
							children: [
								...
								/* @__PURE__ */ jsx("div", { className: "absolute inset-0 bg-gradient-to-t from-black/80 via-transparent to-black/10" }),
								/* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsx("div", {
						...
						children: processSteps.map((step, index) => /* @__PURE__ */ jsx(Reveal, {
							delay: index * .04,
							className: "relative",
							as: "div",
