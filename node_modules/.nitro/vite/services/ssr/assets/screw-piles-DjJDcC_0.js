import { a as img, c as pileMatrix, l as pileTypes } from "./data-DICVWIok.js";
...
import { t as PageHero } from "./PageHero-CwH4hGRu.js";
import { Fragment, jsx, jsxs } from "react/jsx-runtime";
import { motion } from "framer-motion";
import { CheckCircle2, Gauge, RotateCw, Target } from "lucide-react";
//#region src/routes/screw-piles.tsx?tsr-split=component
var ease = [
	.16,
	.84,
	.24,
	...
	return /* @__PURE__ */ jsxs(Fragment, { children: [
		...
		/* @__PURE__ */ jsx("section", {
			...
			children: /* @__PURE__ */ jsx("div", {
				...
				children: pileTypes.map((p, i) => /* @__PURE__ */ jsx(Reveal, { children: /* @__PURE__ */ jsxs(motion.div, {
					...
					children: [/* @__PURE__ */ jsx(motion.div, {
						...
						children: [
							/* @__PURE__ */ jsx("div", {
								...
								children: /* @__PURE__ */ jsx(TechLine, { className: "flex-shrink-0" })
							}),
							/* @__PURE__ */ jsx("p", {
							...
							/* @__PURE__ */ jsx("div", {
								...
								children: p.applications.split(", ").map((app) => /* @__PURE__ */ jsx("span", {
		...
		/* @__PURE__ */ jsx(OldWayVsScrewPile, {}),
		/* @__PURE__ */ jsx(InstallStrip, {}),
		/* @__PURE__ */ jsxs("section", {
			...
			children: [/* @__PURE__ */ jsx("div", {
				...
				children: [
					/* @__PURE__ */ jsx(Reveal, { children: /* @__PURE__ */ jsx(Label, {
						tone: "yellow",
					...
					/* @__PURE__ */ jsx(motion.div, {
						...
						children: /* @__PURE__ */ jsxs("table", {
							...
							}) }), /* @__PURE__ */ jsx("tbody", { children: pileMatrix.rows.map((r, idx) => /* @__PURE__ */ jsxs(motion.tr, {
				...
				/* @__PURE__ */ jsx("div", {
					...
					children: [{
						...
						children: /* @__PURE__ */ jsxs(motion.div, {
							...
							transition: { duration: .3 },
							children: [
								c.variant === "new" && /* @__PURE__ */ jsx("span", {
								...
								/* @__PURE__ */ jsx("div", {
									...
									children: c.variant === "old" ? /* @__PURE__ */ jsxs("svg", {
										width: "90",
										height: "100",
										viewBox: "0 0 90 100",
										fill: "none",
								...
								/* @__PURE__ */ jsx("p", {
									...
									children: c.steps.map((step, idx) => /* @__PURE__ */ jsxs("span", {
										className: "inline-flex items-center gap-2",
										children: [/* @__PURE__ */ jsx("span", {
											className: c.variant === "new" ? "font-medium text-foreground" : "",
											children: step
										}), idx < c.steps.length - 1 && /* @__PURE__ */ jsx("span", {
											"aria-hidden": true,
